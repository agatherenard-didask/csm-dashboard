...
function drawTable() {
  ...
  data.forEach(c => {
    ...
    const stip = `<div class="tb"><div class="tt">Détail Health Score</div><div class="tr"><span class="tl">Account Pulse</span><span class="tv">${d.pp}/20</span></div><div class="tr"><span class="tl">Engagement</span><span class="tv">${d.ep}/40</span></div><div class="tr"><span class="tl">Relation</span><span class="tv">${d.rp}/30</span></div><div class="tr"><span class="tl">Proactivité</span><span class="tv">${d.pro}/10</span></div><div class="ttot"><span>Total</span><span class="ttot-val" style="color:${sc(s)};">${s}/100</span></div></div>`;
