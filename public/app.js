...
function drawTable() {
  ...
  data.forEach(c => {
    ...
    const stip = `<div class="tb"><div class="tt">Détail Health Score</div><div class="tr"><span style="color:var(--peach)">Sentiment CSM</span><span class="tv">${d.pp}/20</span></div><div class="tr"><span style="color:var(--peach)">Engagement</span><span class="tv">${d.ep}/40</span></div><div class="tr"><span style="color:var(--peach)">Relation</span><span class="tv">${d.rp}/30</span></div><div class="tr"><span style="color:var(--peach)">Proactivité</span><span class="tv">${d.pro}/10</span></div><div class="ttot"><span style="color:var(--peach)">Total</span><span style="color:#fff">${s}/100</span></div></div>`;
